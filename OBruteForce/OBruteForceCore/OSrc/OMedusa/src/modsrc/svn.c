...
#define MODULE_VERSION_SVN "$Id: svn.c 569 2006-07-31 21:01:06Z jmk $"
...
int initModule(sLogin* psLogin, _SVN_DATA *_psSessionData)
{
  ...
  writeError(ERR_DEBUG, "[%s] Set URL: %s", MODULE_NAME, _psSessionData->szURL);
