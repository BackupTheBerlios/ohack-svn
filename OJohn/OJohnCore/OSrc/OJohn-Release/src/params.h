...
/*Omar moficaciones*/
/*Seccion Especiak donde OBtengo los Macros en forfa de Variables globales */
char* OGetJOhnPrivateHome(char *PATH_ADD);
char* OGetJohnSystemWide(char *PATH_ADD);
//const char *JOHN_PRIVATE_HOME;
/*end OMar Mod*/


#if JOHN_SYSTEMWIDE
#ifndef JOHN_SYSTEMWIDE_EXEC /* please refer to the notes above */
#define JOHN_SYSTEMWIDE_EXEC		OGetJohnSystemWide("OBin/john")
//#define JOHN_SYSTEMWIDE_EXEC		"$OHACK/OBin/john"
#endif
#ifndef JOHN_SYSTEMWIDE_HOME
#define JOHN_SYSTEMWIDE_HOME		OGetJOhnPrivateHome(".OHack/OJohn/")
//#define JOHN_SYSTEMWIDE_HOME		"$OHACK/OJohn/OJohnCore/OJohnConfig"
#endif
// #define JOHN_PRIVATE_HOME		OGetJOhnPrivateHome(".OHack/OJohn")
#define JOHN_PRIVATE_HOME		"~/.OHack/OJohn/"
#endif
 ...
 * File names.
 */
#define CFG_FULL_NAME			OGetJOhnPrivateHome(".OHack/OJohn/john.conf")
#define CFG_ALT_NAME			OGetJOhnPrivateHome(".OHack/OJohn/john.ini")
#if JOHN_SYSTEMWIDE

#define CFG_PRIVATE_FULL_NAME		JOHN_PRIVATE_HOME "/john.conf"
#define CFG_PRIVATE_ALT_NAME		JOHN_PRIVATE_HOME "/john.ini"
#define POT_NAME			JOHN_PRIVATE_HOME "/OLog/john.pot"
#define LOG_NAME			JOHN_PRIVATE_HOME "/OLog/john.log"
#define RECOVERY_NAME			JOHN_PRIVATE_HOME "/OLog/john.rec"
...
#define WORDLIST_NAME			JOHN_PRIVATE_HOME "/ODictionaries/password.dic"
